    ...
    <section class="mx-auto container bg-white border border-gray-400 min-h-screen p-12">
        ...
        <div class="mt-20">
            ...
            <button @click="addMoreItems()" class="mt-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
             ...
             <button @click="Object.assign(data,invoice1)" class="mt-5 ml-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                Load Invoice-1
            </button> 
            <button @click="Object.assign(data,invoice2)" class="mt-5  ml-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                Load Invoice-2
            </button>
            <p class="mt-5">
                {{ data }}
                ...
                <div class="flex flex-col w-1/2 items-end">
                    <div class="mt-10 flex-y-5 text-right space-y-3 w-full">
                        ...
                        <!-- <p>
                            ...
                            <input v-model="dueBalance" readonly class="focus:ring-0 focus:ring-offset-0 text-right ml-2 pr-4 w-[200px] border-0" placeholder="Balance">
                        </p> -->
                    </div>
                </div>
            </div>
